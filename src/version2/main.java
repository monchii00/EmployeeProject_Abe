...
public class main {
    ...
    public static void main(String[] args) {
        ...
        version1.PieceWorkerEmployee pieceEmp1 = new version1.PieceWorkerEmployee();
        pieceEmp1.setEmpID(101);
        pieceEmp1.setEmpName("Marie Clam");
        pieceEmp1.setTotalPiecesFinished(250);
        pieceEmp1.setRatePerPiece(15.00);

        version1.PieceWorkerEmployee pieceEmp2 = new PieceWorkerEmployee(102, "Kaelix Yu", 420, 20.00);

        version1.HourlyEmployee hourlyEmp1 = new version1.HourlyEmployee();
        ...
        version1.HourlyEmployee hourlyEmp2 = new HourlyEmployee(202, "Gabbie Lea", 48.5f, 250.00);

        version1.CommissionEmployee commEmp1 = new version1.CommissionEmployee();
        commEmp1.setEmpID(301);
        commEmp1.setEmpName("Rae Monique");
        commEmp1.setTotalSale(45000.00);

        version1.CommissionEmployee commEmp2 = new CommissionEmployee(302, "Enna Alouette", 120000.00);

        version1.BasePlusCommissionEmployee baseCommEmp1 = new version1.BasePlusCommissionEmployee();
        ...
        version1.BasePlusCommissionEmployee baseCommEmp2 = new BasePlusCommissionEmployee(402, "Melchora Aquino", 550000.00, 25000.00);
